  ...
  <div id="login">
    ...
    <el-row class="main-container">
      <el-col :lg="8" :xs="16" :md="10" :span="10">
        <div class="top">
          <i class="iconfont icon-kaoshi"></i><span class="title">环球雅思教育考试管理系统</span>
        </div>
        <div class="bottom">
          <div class="container">
...
<!--        <p class="msg2">版权所有 ©2019 &lt;!&ndash;重庆文理学院计科2班余晓江&ndash;&gt; 保留所有权利  <a href="http://beian.miit.gov.cn/" target="_blank">渝ICP备19001371号</a></p>-->
        <p class="msg2">版权所有 ©2019 吉首大学软件3班陈卓 保留所有权利</p>
      </el-col>
    </el-row>
...
#login .bg {
  ...
  overflow-y: auto;
  height: 100%;
  background: url('../../assets/img/loginbg_cz2.png')center top / cover no-repeat;
