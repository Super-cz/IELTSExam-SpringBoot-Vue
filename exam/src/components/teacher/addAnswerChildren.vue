    ...
    <el-tab-pane name="first">
      ...
      <section class="append">
        ...
        <div class="change" v-if="optionValue == '选择题'">
          <div class="title">
            <el-tag>题目:</el-tag><span>在下面的输入框中输入题目,形如--Why don’t you do something about your room —it’s really a ______。</span>
            <el-input
              type="textarea"
              rows="4"
        ...
        <div class="change fill" v-if="optionValue == '填空题'">
          <div class="title">
            <el-tag>题目:</el-tag><span>输入题目,形如--During the sixties and seventies, attaining huge muscles became more important than () or having an attractive-looking body.注意需要考生答题部分一定要用括号（英文半角）括起来。</span>
            <el-input
              type="textarea"
              rows="4"
...
export default {
  ...
  methods: {
    ...
    getParams() {
      ...
      this.postPaper.subject = subject
    },
